...
export default function Sales() {
  ...
  return (
    <DefaultLayout>
      ...
      <DropSearch className="input-search" setValue={setValue} value={value}/>
      <InputField className="input-class"  setSearch={setSearch}/>
      <Button type="primary" className="reset" onClick={refreshPage}>RESET</Button>
      </div>
      ...
      {addEditModalVisbility && (
        ...
        >
          ...
          >
            ...
            {addNew && <DynamicInput a_total={a_total} set_a_Total={set_a_Total}/>}
