...
export default function CustomerById() {
  ...
  console.log(`A total ${billsData.a_total +billsData.total}+${billsData.total}`)
          ...
          >
            <div className="container">
              <div className="brand-section">
                <div className="row">
                  <div className="col-6">
                    <img src={cimpex} alt="cimpex_logo" className="invoice_logo"/>
                  </div>
                  <div className="col-6">
              ...
              <div className="body-section">
                ...
                <table className="table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>2</td>
                      <td>Usha Martin {billsData.another_product}</td>
                      <td>{billsData.a_unit_price}</td>
                      <td>{billsData.a_unit_sold}</td>
                      <td>{billsData.a_total}</td>
                    </tr>}
                    <tr>
                      <td colspan="4" className="text-right">
                        Sub Total
                      </td>
                      <td> {billsData.a_total ? billsData.total + billsData.a_total: billsData.total} </td>
                    </tr>
                    <tr>
                      <td colspan="4" className="text-right">
                        Delivery Charge
                      </td>
                      <td> {billsData.d_charge ? billsData.d_charge : '0'}</td>
                    </tr>
                    <tr>
                      <td colspan="4" className="text-right">
                        Advance
                      </td>
                      <td> {billsData.advance ? billsData.advance : ''}</td>
                    </tr>
                    <tr>
                      <td colspan="4" className="text-right">
                        Discount
                      </td>
                      <td> {billsData.discount ? billsData.discount : '0'}</td>
                    </tr>
                    <tr>
                      <td colspan="4" className="text-right final_amount">
                        Final Due
                      </td>
                      <td>
                        {" "}
                        {billsData.total +
                          billsData.d_charge -
                          billsData.advance -billsData.discount}
                      </td>
                    </tr>
                  </tbody>
                </table>
